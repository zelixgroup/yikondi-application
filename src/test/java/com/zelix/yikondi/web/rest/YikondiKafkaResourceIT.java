...
public class YikondiKafkaResourceIT {
    ...
    @Autowired
    private YikondiKafkaProducer producer;

    @Autowired
    private YikondiKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        YikondiKafkaResource kafkaResource = new YikondiKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/yikondi-kafka/publish?message=test"))
