...
export class PatientFavoritePharmacyService {
  ...
  public resourceSearchUrl = SERVER_API_URL + 'api/_search/patient-favorite-pharmacies';
  ...
  search(req?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(req);
    return this.http
      .get<IPatientFavoritePharmacy[]>(this.resourceSearchUrl, { params: options, observe: 'response' })
      .pipe(map((res: EntityArrayResponseType) => this.convertDateArrayFromServer(res)));
  }
